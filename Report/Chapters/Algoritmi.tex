...
In Figura \ref{selezione_rami} è presente una rappresentazione della \textbf{fase 3}.
\begin{figure}[h] 
\begin{center} 
  % Requires \usepackage{graphicx} 
  \includegraphics[width=8cm]{Images/x_best}\\ 
  \caption{\footnotesize{Selezione rami}}
  \label{selezione_rami} 
\end{center} 
\end{figure}
\vspace{12cm}
\\Di seguito è riportato lo pseudocodice dell'algoritmo appena descritto.\\
\begin{algorithm}
\caption{Hard Fixing}
\begin{algorithmic}
